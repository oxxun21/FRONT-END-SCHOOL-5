...
// foo()  => 실행 X
// 함수를 감싸고 있는 () 자체가 스코프가 되어서 빠져나오지 못함
...
// call by value(call by reference는 존재X), sharing
...
값변경1(test1)
console.log(test1); // [100, 20, 30] 변경 O
...
test(a)
a // 다른 언어의 경우 call by ref로 동작하여 a의 값이 1000으로 바뀜
/*
call by value
